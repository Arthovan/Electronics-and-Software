"""--------------------- Modules Import --------------"""
import machine	# moudle to use the ports and pins, have to access everything like basic == 1
...
elif basic == 2: #-------------- Matrix Keypad 4*3
    """	PICO IO		Keypad
        GPIO 2		1 - Row 1
        GPIO 3		2 - Row 2
        GPIO 4		3 - Row 3
        ...
        for row in range(4):
            ...
            for col in range(3):           
                if column_pins[col].value() == 1:
                    ...
                    print("You have pressed: ", entered_key[key_count])
                    utime.sleep(0.3)
                    key_count += 1
